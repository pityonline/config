...
alias au='sudo apt-get update && sudo apt-get upgrade && sudo apt-get autoremove && sudo apt-get autoclean'
...
alias rebuild='sudo find . -type d -exec chmod 755 {} \; && sudo find . -type f -exec chmod 644 {} \; && sudo find . -type f -exec chmod +x {} \;'
...
# 加入adb路径
# export PATH=/home/pity/test/android-sdk-linux_86/platform-tools/
